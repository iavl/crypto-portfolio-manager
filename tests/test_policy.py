...
class PolicyTests(unittest.TestCase):
    def test_canonical_policy_loads_and_normalizes(self):
        ...
        self.assertEqual(policy.scoring_profile("AAVE")["onchain"], 0.0)
        self.assertEqual(policy.scoring_profile("AAVE")["capital_flows"], 0.0)
        self.assertEqual(set(policy.events["lookback_days"]["FULL_REVIEW"]), {"security", "regulatory"})
