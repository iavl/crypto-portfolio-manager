...
class MetricAvailabilityTests(unittest.TestCase):
    def test_required_scoring_coverage_excludes_optional_and_context_metrics(self):
        self.assertTrue(contributes_to_scoring_coverage("BTC", "onchain.transaction_count"))
    ...
    def test_semantic_applicability_is_fail_closed_before_routing(self):
        ...
        plan = MetricCollectionPlan("SNAPSHOT_REVIEW", (MetricRequest("BTC", "tokenomics.next_unlock_pct"),))
